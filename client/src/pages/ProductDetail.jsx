                    ...
                    <div>
                        ...
                        <div className='flex flex-col w-full sm:w-3/4 lg:w-1/2 space-y-5'>
                            <div className='flex justify-between'>
                                <p className='text-lg font-semibold tracking-wider text-gray-600'>Locación</p>
                                <p>{location}</p>
                            </div>
                            <div className='flex justify-between'>
                            ...
                            <div className='flex justify-between'>
                                <p className='text-lg font-semibold tracking-wider text-gray-600'>Certificación :</p>
                                <p>{certification}</p>
                            </div>
                            <div className='flex justify-between'>
                            ...
                            <div className='flex justify-between'>
                                <p className='text-lg font-semibold tracking-wider text-gray-600'>Marca :</p>
