    ...
    return (
        <div className='w-[80vw] mx-auto py-40 text-center'>
            <div className='text-center'>
                <h2 className='text-4xl capitalize tracking-widest mb-3 font-bold leading-none'>Productos destacados</h2>
                ...
                {products.slice(0, 3).map((product) => (
                    <div key={product.id}>
                        <div className='relative rounded-md'>
                            ...
                            <img className='w-full h-[225px] block object-contain rounded' src={"/" + product.images[0].image} alt={product.name} />
                        </div>
