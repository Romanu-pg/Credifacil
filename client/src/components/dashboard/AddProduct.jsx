        ...
        <div className="w-3/4">
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="flex flex-col space-y-1 mb-8">
              ...
              >
                <option value=""></option>
                <option value="desktop">agricultura</option>
                <option value="laptop">industria Química</option>
                <option value="printer">eficiencia Energética</option>
                <option value="scanner">energia Renovable</option>
                <option value="tablet">hogar y Comunidad</option>
                <option value="monitor">biomasa</option>
              </select>
            ...
            {/* brand input */}
            <label htmlFor="company" className="tracking-wider">
                Company name:
              </label>
              <input
                type="text"
            ...
            {/* shipping input */}
            <div className="flex items-center py-2 space-x-3 mb-8">
              <input
                type="checkbox"
                name="shipping"
                id="shipping"
