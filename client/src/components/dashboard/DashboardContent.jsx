    ...
    return (
        <div className=''>
            ...
            <div className='bg-indigo-200 m-7 p-6'>
                <div className='text-4xl text-gray-800 font-medium'>Buenos días, Administrador.😃</div>
                <div className='mt-4'>Estos son las estadísticas de hoy, ten un buen día.</div>
            </div>
            {/* end banner */}
